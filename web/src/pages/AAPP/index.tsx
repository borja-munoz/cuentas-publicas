...
export default function AappResumen() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        subtitle={`Cuentas consolidadas · SEC2010 · ${effectiveYear ?? '—'}${effectiveYear !== selectedYear && effectiveYear != null ? ' (último disponible)' : ''}`}
      />
